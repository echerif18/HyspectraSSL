...
if __name__ == "__main__":
    ...
    for seq_size in param_grid:
        ...
        run_mae = 'MAE_{}_Training_SeqSize{}_{}UNlabels_{}'.format(formatted_datetime, seq_size, name_experiment, seed)
        ...
        mean_metrics, std_metrics= run_consistent_experiment(checkpoint_dir_mae, path_data_lb, save=True, n_epochs=1)
